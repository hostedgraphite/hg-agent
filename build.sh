...
pip install pyinstaller==3.1.1    \
            ...
            multitail2==1.4.1     \
            pymongo==3.5.1       \
            'git+ssh://git@github.com/hostedgraphite/hg-agent-periodic.git@1.1.0#egg=hg_agent_periodic'\
            'git+ssh://git@github.com/hostedgraphite/hg-agent-forwarder.git@1.1.0#egg=hg_agent_forwarder'
