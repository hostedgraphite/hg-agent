...
a = Analysis(analysis_paths,
             ...
             datas=[
                 ...
                 ('/hg-agent.venv/lib/python3.8/site-packages/supervisor/version.txt', 'supervisor'),

                 # the jinja2 template for hg-agent-periodic
                 ('/hg-agent.venv/lib/python3.8/site-packages/hg_agent_periodic/templates', 'hg_agent_periodic/templates')
             ],
